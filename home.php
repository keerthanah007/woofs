	...
	if(isset($_POST['login'])){
		...
		if(sizeof($res)>0){
			...
			if ($res[0]['user_type']=="admin"){
				...
				return redirect('staff.php');
			}
			else if($res[0]['user_type']=="customer"){


				$q="select * from tbl_customer where username='$lid'";
				$res=select($q);
				if (sizeof($res)>0) {
			...
			<div class="banner-top w3layouts">
				<div class="container">
					<ul class="agile_top_section">
						...
						<a class="sign" href="cust_reg.php"> <i class="fa fa-sign-in" aria-hidden="true"></i>Register</a></li>
					</ul>
				</div>
			</div>
